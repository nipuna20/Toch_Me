...
class _Page17State extends State<Page17> {
  double frameRadius = 80; // Controls outer frame size
  double imageScale = 0.85; // Controls image size inside frame (0.0 to 1.0)
    ...
    return Scaffold(
      ...
      body: ResponsiveWrapper.builder(
        SafeArea(
          child: Stack(
            children: [
              // Position p7i2.png image at the top-left corner inside a circular frame
              Positioned(
