    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          _buildSection("Profile Details", "assets/profile.png", () {
            Navigator.push(context, MaterialPageRoute(builder: (_) => Page16()));
          }),
          _buildSection("Payment Method", "assets/payment.png", () {
            Navigator.push(context, MaterialPageRoute(builder: (_) => Page14()));
          }),
          _buildSection("About", "assets/about.png", () {
