...
class Page35Content extends StatefulWidget {
  const Page35Content({super.key});

  @override
  _Page35ContentState createState() => _Page35ContentState();
}

class _Page35ContentState extends State<Page35Content> {
  ...
  void navigateToPage(int index, BuildContext context) {
    switch (index) {
      case 0:
        Navigator.push(context, MaterialPageRoute(builder: (_) => Page35()));
        break;
      case 1:
        Navigator.push(
          context,
            ...
            builder: (_) => Builder(
              builder: (context) {
                return Page8(
                  ...
                  appointmentTime: DateTime.now(), // Set to the current date and time
                );
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    prefixIcon: Padding(
                                      ...
                                      child: Image.asset(
                                        ...
                                        width: 20,
                                        height: 20,
                                        errorBuilder: (_, __, ___) => const Icon(Icons.search, color: Colors.grey),
                                      ),
                                    ),
                                ...
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    Image.asset(
                                      ...
                                      width: 10,
                                      height: 10,
                                      errorBuilder: (_, __, ___) => const Icon(Icons.arrow_drop_down, color: Colors.grey),
                                    ),
                                  ],
                                );
                              },
